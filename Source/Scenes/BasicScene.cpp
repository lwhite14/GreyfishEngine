...
void BasicScene::Start(GLFWwindow* window)
{
    ...
    m_sceneObjects[m_sceneObjects.size() - 1]->AddComponent(ObjMesh::Load("Assets/Models/suzanne.obj", m_sceneObjects[m_sceneObjects.size() - 1], MasterTextures::textureList[0]));
